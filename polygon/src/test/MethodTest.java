...
public class MethodTest {
    ...
    public static void main(String[] args) {
        ...
        String sourceFile = ClassLoader.getSystemResource("").getPath() + properties.getProperty("sourceFile");
        String targetFile = ClassLoader.getSystemResource("").getPath() + properties.getProperty("targetFile");
        String rangeFile = ClassLoader.getSystemResource("").getPath() + properties.getProperty("rangeFile");
